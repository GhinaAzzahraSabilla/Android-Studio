package id.ac.poliban.mi.ghina.simpleshoppinglist;
...
import id.ac.poliban.mi.ghina.simpleshoppinglist.databinding.ActivityItemListBinding;

public class ItemListActivity extends AppCompatActivity {
    public final static String ITEM_TAG = "id.ac.poliban.mi.ghina.simpleshoppinglist.EXTRA.ITEM";
